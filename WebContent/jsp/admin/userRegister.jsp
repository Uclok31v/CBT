  ...
  <body style="padding-top:5rem">
  		...
  		<form action="./userRegister" method="post" name="userRegister">
  			...
  			<div class="form-group mb-4">ユーザ区分<br>
  				<div class="form-check form-check-inline mr-4">
  					<input class="form-check-input" type="radio" name="administrator" id="examinee" value="0" checked onClick="changeDisabled()">
  					<label class="form-check-label" for="examinee">受験者</label>
  				</div>
  				<div class="form-check form-check-inline mr-4">
  					<input class="form-check-input" type="radio" name="administrator" id="administrator" value="1" onClick="changeDisabled()">
  					<label class="form-check-label" for="administrator">管理者</label>
  				</div>
  			</div>
  			...
  			<div>
  				...
  				<a href="/CBT/jsp/admin/userRegister.jsp" class="btn btn-light">キャンセル</a>
  			</div>
  			<div class="text-left">
  				<font color="red">
  					<%= error %>
    ...
    <script type="text/javascript">
     function changeDisabled() {
        if ( document.userRegister["administrator"][0].checked ) {
            document . userRegister["role_1"] . disabled = false;
            document . userRegister["role_2"] . disabled = false;
            document . userRegister["role_3"] . disabled = false;
            document . userRegister["role_4"] . disabled = false;
            document . userRegister["role_5"] . disabled = false;
            document . userRegister["role_6"] . disabled = false;
        } else {
        	document . userRegister["role_1"] . checked = false;
            document . userRegister["role_2"] . checked = false;
            document . userRegister["role_3"] . checked = false;
            document . userRegister["role_4"] . checked = false;
            document . userRegister["role_5"] . checked = false;
            document . userRegister["role_6"] . checked = false;
            document . userRegister["role_1"] . disabled = true;
            document . userRegister["role_2"] . disabled = true;
            document . userRegister["role_3"] . disabled = true;
            document . userRegister["role_4"] . disabled = true;
            document . userRegister["role_5"] . disabled = true;
            document . userRegister["role_6"] . disabled = true;
        }
     }
