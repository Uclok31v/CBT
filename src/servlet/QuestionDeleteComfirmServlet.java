...
/**
 * Servlet implementation class QuestionDeleteComfirmServlet
 */
@WebServlet("/QuestionDeleteComfirmServlet")
public class QuestionDeleteComfirmServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public QuestionDeleteComfirmServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher("/jsp/admin/questionDeleteComfirm.jsp").forward(request, response);
	}
