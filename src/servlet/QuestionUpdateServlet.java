...
request.setCharacterEncoding("UTF-8");
		...
		new QuestionDao().updateQuestionById(questionId,text,choice1,choice2,choice3,choice4,correct,role1,role2,role3,role4,role5,role6,role7,role8,role9,pattern,owner);
		...
		request.getRequestDispatcher("/jsp/admin/questionUpdated.jsp").forward(request, response);
	}
