	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (administrator == 0) {
			...
			if (request.getParameter("role_2") != null) {
				role1 = Integer.parseInt(request.getParameter("role_2"));
			}
			if (request.getParameter("role_3") != null) {
				role1 = Integer.parseInt(request.getParameter("role_3"));
			}
			if (request.getParameter("role_4") != null) {
				role1 = Integer.parseInt(request.getParameter("role_4"));
			}
			if (request.getParameter("role_5") != null) {
				role1 = Integer.parseInt(request.getParameter("role_5"));
			}
			if (request.getParameter("role_6") != null) {
				role1 = Integer.parseInt(request.getParameter("role_6"));
			}
			if (request.getParameter("role_7") != null) {
				role1 = Integer.parseInt(request.getParameter("role_7"));
			}
			if (request.getParameter("role_8") != null) {
				role1 = Integer.parseInt(request.getParameter("role_8"));
			}
			if (request.getParameter("role_9") != null) {
				role1 = Integer.parseInt(request.getParameter("role_9"));
			}
		}
		...
		if (checkUser) {
			new UserDao().insertUser(userId,userName,administrator,role1,role2,role3,role4,role5,role6,role7,role8,role9,dateTime);
